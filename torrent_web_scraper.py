...
def main():
    ...
    scraper = ScraperTorrent(local_machine_status_file, local_machine_badsites_file, local_machine_history_file)
    ...
    for goodsite in goodsites:
        ...
        scraper.execute_scraper(goodsite)

        if two_times == 1: break
        two_times += 1
